<x-layout>
   ...
   <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
      ...
      <form method="POST" action="/jobs" enctype="multipart/form-data">
         ...
         <x-inputs.text id="salary" type="number" name="salary" label="Gross Annual Salary (EUR)" placeholder="60000" />

         <x-inputs.text-area id="requirements" name="requirements" label="Requirements" placeholder="Bachelor's degree in Computer Science or relevant experience" />

         <x-inputs.text-area id="benefits" name="benefits" label="Benefits" placeholder="Private Health Insurance, 30 days vacation, Fitness, Bike-Leasing, etc." />
         ...
         <x-inputs.text id="address" name="address" label="Address" placeholder="Müsterstr. 1" />

         <x-inputs.text id="city" name="city" label="City" placeholder="Düsseldorf" />

         <x-inputs.text id="state" name="state" label="State" placeholder="NRW" />

         <x-inputs.text id="zipcode" name="zipcode" label="ZIP Code" placeholder="40500" />
         ...
         <x-inputs.text id="company_website" type="url" name="company_website" label="Company Website" placeholder="Enter website url" />

         <x-inputs.text id="contact_phone" name="contact_phone" label="Contact Phone" placeholder="Enter phone number" />

         <x-inputs.text id="contact_email" type="email" name="contact_email" label="Contact Email" placeholder="Email where you want to receive the applications" />

         <x-inputs.file id="company_logo" type="file" name="company_logo" label="Company Logo" />
