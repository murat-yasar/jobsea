<x-layout>
   ...
   <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
      ...
      <form method="POST" action="/jobs" enctype="multipart/form-data">
         ...
         <x-inputs.text id="salary" type="number" name="salary" label="Annual Salary" placeholder="90000" />
         ...
         <x-inputs.text id="company_website" name="company_website" label="Company Website" placeholder="Enter website url" />
